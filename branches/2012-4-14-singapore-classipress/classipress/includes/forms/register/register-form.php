...
?>
            ...
            <form action="<?php echo $action; ?>" method="post" class="loginform" name="registerform" id="registerform">
                ...
                <p>
                    ...
                    <input tabindex="1" type="text" class="text" name="user_login" id="user_login" value="<?php if (isset($posted['user_login'])) esc_attr_e($posted['user_login']); ?>" />
                </p>

                <p>
                    <label for="user_email"><?php _e('Email:','appthemes') ?></label>
                    <input tabindex="2" type="text" class="text" name="user_email" id="user_email" value="<?php if (isset($posted['user_email'])) esc_attr_e($posted['user_email']); ?>" />
                </p>
