...
function cp_bank_owner_new_ad_email($post_id) {
    ...
    $message  = sprintf(__('Hi %s,', 'appthemes'), $ad_author) . "\r\n\r\n";
    $message .= sprintf(__('Gracias por tu reciente publicación! Tu anuncio ha sido enviado para su revisión y será visible en nuestro sitio una vez haya sido aprobado y que hayamos recibido el pago. Debajo encontrarás un sumario de tu anuncio en %s.', 'appthemes'), $blogname) . "\r\n\r\n";
    $message .= __('Ad Details', 'appthemes') . "\r\n";
    $message .= __('-----------------') . "\r\n";
    $message .= __('Title: ', 'appthemes') . $ad_title . "\r\n";
    $message .= __('Category: ', 'appthemes') . $ad_cat . "\r\n";
    ...
    $message .= __('Por favor, incluya los siguientes datos al hacer el pago. Una vez verificado, su anuncio será publicado.') . "\r\n\r\n";
    $message .= __('Detalles para el pago', 'appthemes') . "\r\n";
    $message .= __('-----------------') . "\r\n";
    $message .= __('Id de transacción: ', 'appthemes') . get_post_meta($post_id, 'cp_sys_ad_conf_id', true) . "\r\n";
    $message .= __('Referencia #: ', 'appthemes') . $post_id . "\r\n";
    $message .= __('Monto total: ', 'appthemes') . get_post_meta($post_id, 'cp_sys_total_ad_cost', true) . " (" . get_option('cp_curr_pay_type') . ")\r\n";
    $message .= __('-----------------') . "\r\n\r\n";
...
function cp_new_membership_email($oid) {
    ...
    if(!empty($orders)){
      ...
      $message .= sprintf(__('Edit User: %s', 'appthemes'), $adminurl) . "\r\n\r\n\r\n";
      $message .= __('Regards,', 'appthemes') . "\r\n\r\n";
      $message .= __('ClassiPress', 'appthemes') . "\r\n\r\n";
