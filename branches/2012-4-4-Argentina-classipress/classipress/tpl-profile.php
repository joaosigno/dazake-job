      ...
      <div class="content_res">
		...
		<table class="form-table">
			<tr>
				...
				<td><input type="text" name="user_login" class="regular-text" id="user_login" value="<?php esc_attr_e( $current_user->user_login ); ?>" maxlength="100" disabled /></td>
			</tr>
			<tr>
				<th><label for="first_name"><?php _e('First Name:','appthemes') ?></label></th>
				<td><input type="text" name="first_name" class="regular-text required" id="first_name" value="<?php esc_attr_e( $current_user->first_name ); ?>" maxlength="100" /></td>
			</tr>
			<tr>
				<th><label for="last_name"><?php _e('Last Name:','appthemes') ?></label></th>
				<td><input type="text" name="last_name" class="regular-text required" id="last_name" value="<?php esc_attr_e( $current_user->last_name ); ?>" maxlength="100" /></td>
			</tr>
			<tr>
				<th><label for="nickname"><?php _e('Nickname:','appthemes') ?></label></th>
				<td><input type="text" name="nickname" class="regular-text" id="nickname" value="<?php esc_attr_e( $current_user->nickname ); ?>" maxlength="100" /></td>
			</tr>
			<tr>
		...
		<tr>
			...
			<td><input type="text" name="email" class="regular-text" id="email" value="<?php esc_attr_e($current_user->user_email); ?>" maxlength="100" /></td>
		</tr>
