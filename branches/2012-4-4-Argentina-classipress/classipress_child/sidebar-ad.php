...
<div class="content_right">
    ...
    <div class="tabprice">
        ...
        <ul class="tabnavig">
          ...
          <?php } ?>
          <li><a href="#priceblock2"><span  style="color:#fc6d26;"class="big"><?php _e('Contact', 'appthemes') ?></span></a></li>
            ...
            <div class="priceblocksmall dotted">
                ...
                <ul class="member">
					...
					<li><span><?php _e('Member Since:','appthemes');?></span> <?php echo date_i18n( get_option('date_format'), strtotime( get_the_author_meta('user_registered') ) ); ?> </li>
                     <li><span><?php _e('Teléfono:','appthemes');?></span> <?php echo get_the_author_meta('user_phone'); ?><span></li>
                   <li><span><?php _e('Tipo de cuenta:','appthemes');?></span> <?php echo get_the_author_meta('user_type'); ?><span> - </span><?php echo get_the_author_meta('user_broker'); ?></li>
