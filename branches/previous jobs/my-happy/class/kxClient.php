...
class KXClient{
	...
	public $client_id = "6450844693976b11a4ea35b367b76f45"; //api key
	public $client_secret = "fe12d345e4c5328fcc2778b70b0b2889"; //app secret
	public $redirect_uri = "http://localhost/xampp/my-happy/class/redirect.php";//回调地址，所在域名必须与开发者注册应用时所提供的网站根域名列表或应用的站点地址（如果根域名列表没填写）的域名相匹配
  ...
  function getAccessTokenFromRefreshToken($refresh_token, $scope) {
	 ...
	 * num	返回数量
     */
    function mfriends_me($start=0,$num=20)
    {
	 ...
	 * num	返回数量
     */
    function records_me($start=0,$num=20,$category=0)
    {
	 ...
	 * num	返回数量
     */
    function records_friends($start=0,$num=20,$category=null)
    {
	 ...
	 * num	返回数量
     */
    function records_public($start=0,$num=20)
    {
	 ...
	 * num	返回数量
     */
    function diary_friends($start=0,$num=20)
    {
	 ...
	 * num	返回数量
     */
    function repaste_friends($start=0,$num=20)
    {
