...
$config->CALLBACK = 'http://localhost/my-renren/example/oauth/2_callback.php'; //回调地址，注意和您申请的应用一致

$config->APIURL		= 'http://api.renren.com/restserver.do'; //RenRen网的API调用地址，不需要修改
$config->APIKey		= '66bab534984c43b0bf8013ed66ef8e35';	//你的API Key，请自行申请
$config->SecretKey	= 'cf7c0115182448c2ac10d1a1951a3e53';	//你的API 密钥
