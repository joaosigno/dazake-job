...
<!-- CONTENT -->
                            ...
                            <td class="text-center">
                                ...
                                if ( $post->post_status == 'pending' && $postaction != 'ended' ) {
                                    ...
                                    if ( ($total_cost != 0) && (get_option('cp_enable_paypal') != 'no') ) {
                                        echo cp_dashboard_paypal_button( $post->ID );
                                    } else {
                                        echo '&mdash;';
                                    }
                                    ...
                                    if ( get_option('cp_allow_relist') == 'yes' ) {
                                        ...
                                        if ( ($total_cost != 0) && get_post_meta($post->ID, 'cp_totalcost', true) == '' ) {
                                            if ( get_option('cp_enable_paypal') != 'no' ) 
                                                echo cp_dashboard_paypal_button( $post->ID );
											else 
											    _e('Contact us to relist ad', 'appthemes');
                                        } else {
  ...
  <div class="shadowblock_out">
            <div class="shadowblock">
             <h1 class="single dotted"><?php printf(__("Favoritos", 'appthemes'), $display_user_name); ?></h1>
