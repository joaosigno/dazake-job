...
--
-- Host: localhost
-- Generation Time: Feb 24, 2012 at 11:44 AM
...
--
-- Table structure for table `wfw_happy_message`
--
...
--
-- Dumping data for table `wfw_happy_message`
--
...
--
-- Table structure for table `wfw_happy_user`
--
...
--
-- Dumping data for table `wfw_happy_user`
--

INSERT INTO `wfw_happy_user` (`id`, `w_id`, `happy_id`, `happy_name`, `access_token`, `refresh_token`, `token_insert_time`) VALUES
(6, 1, 0, '', '38918513_42667d70bf3fb64e3b240cdd958812b9', '38918513_927aca220d6aed9e409da129c133c395', 1323423640);

-- --------------------------------------------------------

--
-- Table structure for table `wfw_renren_message`
--
...
--
-- Dumping data for table `wfw_renren_message`
--
...
--
-- Table structure for table `wfw_renren_user`
--
...
--
-- Dumping data for table `wfw_renren_user`
--
...
--
-- Table structure for table `wfw_sina_message`
--
...
--
-- Dumping data for table `wfw_sina_message`
--
...
--
-- Table structure for table `wfw_sina_user`
--
...
--
-- Dumping data for table `wfw_user`
--
